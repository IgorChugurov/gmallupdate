    ...
    function gmallSliderHomeDirective($timeout,global){
        return {
            ...
            link:function(scope,element,attr,$ctrl){
                ...
                $ctrl.slideswipeLeft=slideswipeLeft
                $ctrl.slideswipeRight=slideswipeRight;
                function slideswipeLeft() {
                    $timeout.cancel(timer)
                    next()
                }

                function slideswipeRight() {
                    $timeout.cancel(timer)
                    prev()
                }
                ...
                $timeout(function(){
                    ...
                    innerDivBox.each(function (i,div) {
                        return;
                        console.log(div)
                        $(div).on( "swipe",function(event){
                            console.log(div,event.gesture.direction)
