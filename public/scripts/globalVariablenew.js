...
var listOfBlocksForStuffDetailBlocks={
    banner:'фото + текстовый блок (один поток)',
    bannerOne:'фото + текстовый блок (два потока)',
    calendar:'календарь',
    date:'дата',
    feedback:'обратная связь',
    ...
    sn:'соцсети',
    text:'текстовый блок',
    textЕцщ:'текстовый блок в две колонки',
    video:'видео',
...
var elementsList=['h1','h2','h3','h4','h5','a','p','div','ol','ul','li','span','img','class','hr']
