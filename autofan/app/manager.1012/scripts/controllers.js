...
//*****************************customer*********************************
        ...
        $scope.changeCustomer=function(id){
            if (!id){
                ...
                JobTicketArch.get({id:id,query:'balance'},function(res){
                    ...
                    $scope.jobTicket.balance=res.balance +res.resSum-res.resPay;
        ...
        $scope.$on('printTicket',function(){
            ...
            var rest = $scope.jobTicket.balance+$scope.getTotalJobs()+$scope.getTotalSpark()-$scope.getTotalPay();
            //console.log(rest);
            ...
            //console.log(s);
            s +='<table width="100%" cellspacing="0" cellpadding="5">' +
                '<tr><td><b style="'+$scope.style+'">Долг '+(order.balance).toFixed(2)+' грн</b></td>' +
                ...
                '<td><b style="'+style+'">Остаток суммы '+(rest).toFixed(2)+' грн</b></td></tr>'+
                '</table><hr style="margin-top: 0; margin-bottom: 0; border-color: #666">';
            ...
            s += '<p style="text-align: center; margin-top: 10px; margin-bottom: 5px;">Платежная ведомость</p>' +
                '<table width="100%" cellspacing="0" cellpadding="5" border="1px">'+
                '<thead><tr><th>#</th><th>Дата</th><th>Сумма</th></tr></thead>';
