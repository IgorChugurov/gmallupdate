        ...
        Promise.resolve()
            ...
            .then(function(items){
                ...
                if(req.mobile || (req.store.template && req.store.template[req.params.type+'List']
                    ...
                    &&req.store.template[req.params.type+'List'].rows==2))){
                    type='listtablet'
                }
                ...
                let rr = 3;
                if(req.store.template && req.store.template[req.params.type+'List'] && req.store.template[req.params.type+'List'].rows){
                    rr = req.store.template[req.params.type+'List'].rows
                    //console.log("req.store.template[req.params.type+'List'].rows",req.store.template[req.params.type+'List'].rows)
                }

                if(type!='listmobile' && type!='listtablet'){
                    d.templ=rr;
                }else{
                    d.templ=''
                }
                ...
                //console.log(a)
                let key ="wrap-list-"+type+d.templ+d.i;
                //console.log(key)
                jadeData.dj[key]={
                    page:page,
                    total:total,
                ...
                if(cartJade = pugCache['list'+typeCart+((element.templ)?element.templ:'')]){
                    ...
                    if(type=='listmobile'){
                        ...
                        if(rr==5){
                            a.splice.apply(a,[41,1].concat(cartJadeArr))
                            a.splice.apply(a,[36,1].concat(cartJadeArr))
                        }else if(rr==4){
                            a.splice.apply(a,[36,1].concat(cartJadeArr))
                        }
                ...
                items.forEach(function (e,i) {
                    ...
                    /*console.log(e.desc)
                    console.log(e.desc.substring(e.desc.length - 3))*/
                    if(e.desc && e.desc.length>155 && e.desc.substring(e.desc.length - 3)!=='...'){
                ...
                //console.log("jadeData.dj[key].itemsArr5",jadeData.dj[key].itemsArr5)
