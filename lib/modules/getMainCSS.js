        ...
        co(function* () {
            ...
            if(addcomponents){
                ...
                if(addcomponents.cabinet){
                    ...
                    //console.log(getMixinForBlocks(addcomponents,'cabinet',k,'class',style))
            ...
            try{
                if(mixin){
                    ...
                    if(compileCss.css){
                        ...
                        fs.writeFile( 'public/css/'+store.subDomain+'.css', compileCss.css, function (err, data) {
                            if (err) {console.log('fs.writeFile',err)}else {console.log('public/css/'+store.subDomain+'.css was written')}
                        } );
                ...
                fs.writeFile( 'public/css/'+store.subDomain+'.mixin.css', mixin, function (err, data) {
                    if (err) {console.log('fs.writeFile',err)}else {console.log('public/css/'+store.subDomain+'.mixin.css was written')}
                } );
                resolve('')
            }
